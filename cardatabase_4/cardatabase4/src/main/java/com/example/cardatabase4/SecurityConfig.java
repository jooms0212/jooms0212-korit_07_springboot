...
public class SecurityConfig {
    ...
    public SecurityConfig(UserDetailsServiceImpl userDetailsService, AuthenticationFilter authenticationFilter, AuthEntryPoint authEntryPoint, AuthEntryPoint exceptionHandler) {
